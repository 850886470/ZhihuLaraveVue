                    ...
                    <div class="card-body">
                        <form action="/questions/{{$question->id}}" method="post">
                            ...
                            <div class="form-group{{$errors->has('title') ? ' has-error':''}}">
                                ...
                                <input value="{{$question->title}}" placeholder="标题" name="title" type="text" class="form-control">
                                @if ($errors->has('title'))
                            ...
                            <div class="form-group{{$errors->has('title') ? ' has-error':''}} ">
                                ...
                                <!-- 编辑器容器 -->
                                <script  class="ue_editor" id="container" name="body" type="text/plain">{!!$question->title!!}</script>
